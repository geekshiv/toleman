...
The check runs against whatever SBOM the target already has. If the SBOM is stale, [regenerate it](./sbom.md) before checking, or use **Import & Check** to pull a fresh inventory and check in one step.
