...
description: "Administration → Control Plane → Tooling → Global Integrations (/api/config, admin-only) holds every cross-cutting integration setting:"
---
...
- **AI provider**: Anthropic or OpenAI-compatible endpoint + key, used by [AI Analysis](/toleman/findings/enrichment-and-ai-analysis/)
