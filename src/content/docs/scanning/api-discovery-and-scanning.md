---
title: "API Discovery & Active Scanning"
description: "Extracts API routes from a target's source via static analysis, then optionally probes discovered endpoints with an active nuclei scan."
---
...
![API Discovery page](/toleman/img/screenshots/api-discovery.png)
