...
![Targets: GitHub App connected, repos synced](/toleman/img/screenshots/targets-list.png)
...
![Control Plane: Global Integrations, GitHub App connection card](/toleman/img/screenshots/admin-integrations.png)
