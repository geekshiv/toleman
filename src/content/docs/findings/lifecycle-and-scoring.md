---
title: "Findings Lifecycle & Priority Scoring"
description: "A Finding moves through a triage state machine, states include (at minimum) Open, Mitigated, Accepted Risk, False Positive, Won't Fix, and Reopened."
---
...
![Findings page: filterable list with risk score, severity, and state](/toleman/img/screenshots/findings.svg)
...
- **Finding age.** Handled by SLA rules, a separate mechanism with its own configuration; see [SLA & Policy](/toleman/findings/sla-and-policy/).
