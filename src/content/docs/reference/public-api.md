...
description: "Programmatic access to targets, findings and scans, authenticated with a personal access token."
---
...
**[Download the OpenAPI 3.1 spec](/toleman/openapi/toleman-public-v1.json)**, generated from the running application, so it describes what the API actually does rather than what someone remembered it doing. Import it into Postman, Insomnia, or any OpenAPI client generator.
