---
title: "MCP Server"
description: "Connect an MCP-compatible client to list targets, browse findings, get a fix recommendation, and open a PR for it."
---
...
Create a personal access token: **Settings → Workspace → API Tokens** (see [Public API Reference](/toleman/reference/api/)). Read-only is enough for every tool except `trigger_scan`.
